...
export async function initializeSpells() {
  ...
  const reparo: InsertSpell = {
    ...
    gesturePattern: [
      ...
      // Точка 2: левый конец
      { x: 109, y: 217 },
      // Точка 2 → 3: поворот влево-вниз
      { x: 100, y: 225 },
      { x: 90, y: 235 },
      // Точка 3: угол
      { x: 78, y: 249 },
      // Точка 3 → 4: диагональ вниз
      { x: 72, y: 270 },
      // Точка 4
      { x: 67, y: 289 },
      // Точка 4 → 5: диагональ вниз-вправо
      { x: 78, y: 315 },
      { x: 90, y: 340 },
      ...
      // Точка 6: самый низ
      { x: 158, y: 407 },
      // Точка 6 → 7: диагональ вправо-вверх
      { x: 175, y: 395 },
      { x: 190, y: 383 },
      // Точка 7: нижняя правая
      { x: 206, y: 371 },
      // Точка 7 → 8: диагональ вверх-вправо
      { x: 225, y: 340 },
      { x: 242, y: 313 },
      // Точка 8: средняя правая
      { x: 260, y: 286 },
      // Точка 8 → 9: диагональ вверх-вправо
      { x: 278, y: 255 },
      { x: 295, y: 228 },
      // Точка 9: верхняя средняя правая
      { x: 315, y: 201 },
      // Точка 9 → 10: диагональ вверх-вправо
      { x: 335, y: 178 },
      { x: 352, y: 159 },
