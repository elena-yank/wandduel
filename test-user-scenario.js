 ...
 * 1. Round 1: Player 1 doesn't attack in time (timeout)
 * 2. Round 2: Timer starts but completes very quickly, Player 2 gets point, Round 3 starts
 */
...
function testUserScenario() {
  ...
  console.log("1. Round 1: Player 1 doesn't attack in time (timeout)");
  console.log("2. Round 2: Timer starts but completes very quickly, Player 2 gets point, Round 3 starts");
  console.log("");
  ...
  // Simulate Round 1: Player 1 times out (didn't attack in time)
  ...
  // Simulate Round 2: Player 2 times out very quickly (as described by user)
