/**
 * Test to specifically check round 1 timeout behavior
 * This test verifies that when player 1 doesn't attack in time in round 1,
 * the game correctly progresses to round 2 (not round 3)
 */
...
// Test specifically for the round 1 timeout transition issue
function testRound1TimeoutTransition() {
  console.log("=== Testing Round 1 Timeout Transition Issue ===\n");
  
  console.log("Scenario:");
  console.log("- Round 1: Player 1 times out (should go to round 2, P1: 0, P2: 1)");
  console.log("");
  ...
  // Simulate round 1: Player 1 times out (this is where the bug occurs)
  console.log("--- Round 1 (Player 1 times out) ---");
  session = {
    ...session,
  ...
  if (session.currentRound === 2) {
    ...
    console.log(`✗ Incorrectly transitioned to round ${session.currentRound} instead of 2`);
  }
